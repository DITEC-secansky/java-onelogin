...
- Admin konzola: `http://localhost:8080/` (admin / admin).
...
```
http://localhost:8080/realms/webssodemo/protocol/saml/descriptor
```
...
|---|---|
| `idp.entityid` | `http://localhost:8080/realms/webssodemo` |
| `idp.single_sign_on_service.url` | `http://localhost:8080/realms/webssodemo/protocol/saml` |
| `idp.single_logout_service.url` | `http://localhost:8080/realms/webssodemo/protocol/saml` |
| `idp.single_logout_service.response.url` | `http://localhost:8080/realms/webssodemo/protocol/saml` |
...
```ini
# --- IdP = Keycloak ---
onelogin.saml2.idp.entityid=http://localhost:8080/realms/webssodemo
onelogin.saml2.idp.single_sign_on_service.url=http://localhost:8080/realms/webssodemo/protocol/saml
onelogin.saml2.idp.single_sign_on_service.binding=urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect
onelogin.saml2.idp.single_logout_service.url=http://localhost:8080/realms/webssodemo/protocol/saml
onelogin.saml2.idp.single_logout_service.response.url=http://localhost:8080/realms/webssodemo/protocol/saml
